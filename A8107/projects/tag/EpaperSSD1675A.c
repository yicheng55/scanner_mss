...
void Write_EXAMPLE_FULL(uint8_t color, uint8_t* ReceiveData)//examplePix
{
	int j = 0;
	uint32_t bitmap = 0;
...
void EPaperShowTagDefaultStatus(const TCHAR *szTagID, const TCHAR *szTagStatus, const TCHAR *szTagMsg1, const TCHAR *szTagMsg2)
{
...
//	OUTPUT_MESSAGE(FLAG_MF_APPLICATION, FLAG_MT_INFORMATION, _T("--- %s ---\r\n"), szTagID);
	...
	LinePrint_Big_Font(2,"%s_%s",szTagMsg1,szTagMsg2);
...
////	Print_Line_Big_Font(4,"DMT2900-8280000002");
...
//		spi3w_wdata(0x33);
//	}
//ENTRY_MESSAGE(FLAG_MF_APPLICATION, _T("(+)0016\r\n"));
//	WriteLUT();
////	Demo_Mode();
//	ENTRY_MESSAGE(FLAG_MF_APPLICATION, _T("(+)017\r\n"));
//	WhiteDM();
