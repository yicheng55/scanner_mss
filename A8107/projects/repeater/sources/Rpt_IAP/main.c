...
uint8_t EpdRFData[EpdUpdateSize];
...
int main(void)
{
	//gDatarate = DATARATE500K;//DATARATE500K;//DATARATE1M;			//Assign the data rate.
	BoardInit();		//Initial hardware system
	
	//NormalIntDefaultHandler();
	//STM8_HanderIqr_Init();
	//NVIC_SetVectorTable(48);
	...
	//StrobeCmd(CMD_STBY);
	//SetCH(RptDefSet.Gchn); //freq 2450MHz CH100 JAMES TEST is 184 or JERRY is 200
